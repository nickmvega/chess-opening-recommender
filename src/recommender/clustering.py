...
Functions:
cluster_styles(style_vectors: pd.DataFrame, n_clusters: int = 4, random_state: int = 42)
...
def cluster_styles(style_vectors: pd.DataFrame, n_clusters: int = 4, random_state: int = 42):
...
def find_style_neighbors(user_vector: pd.Series, style_vectors: pd.DataFrame,
                        scaler: StandardScaler, top_n: int = 5) -> pd.DataFrame:
